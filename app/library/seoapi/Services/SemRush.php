...
/*
 * Credit https://github.com/AgencyPMG/SEMRush-API-for-PHP/blob/master/SemRush.php
 */
...
class SEMRush extends seoapi
{
    public static function getDBs()
    {
        return array(
            /*VALID COUNTRIES WHICH SEMRUSH USES */
    ...
    public static function getDomainGraph($reportType = 1, $url = false, $db = false, $w = 400, $h = 300, $lc = 'e43011', $dc = 'e43011', $lang = 'en', $html = true)
    {
        $db       = false !== $db ? $db : Config\DefaultSettings::SEMRUSH_DB;
        $url      = self::getUrl($url);
        $domain   = Helper\Url::parseWebsite($url);
    ...
    private static function getApiData($url)
    {
        ...
        return Helper\Json::decodeJson($json, true);
    }
