...
<?php
	...
	$url_metrics = json_decode($api->urlMetrics('$url', 133714411517));
?>
<?php /*
...
<div class="container-fluid" >
	<div class="researchForm"> 
		<form name="url" action="HTML::link('clients/research/summarypopop')" method="GET">
			<input type="url" id="siteURL" autofocus="on" placeholder="http://www.example.com" required="on" class="inputUrlBox">
...
<div class="container-fluid" >
	<div class="researchForm"> 
		<form name="siteURL" action="Mozscape_script.php" method="post">
			<input type="text" name="url" autofocus="on" placeholder="http://www.example.com" required="on" class="inputUrlBox">
			<input type="submit" name="submit" value="Research" class="inputUrlSubmit">		
		</form>		
	</div>	
</div>
...
<!-- /* Dom's preloaded APIs */ -->

<!-- <? php	
		use \seoapi\Services as seoapi;

try {
  $url = 'http://www.sfu.ca/';
  $keyword = "school";

  // Create a new seoapi instance.
  $seoapi = new \seoapi\seoapi;

  // Bind the URL to the current seoapi instance.

      echo "Global Rank: ";
seoapi\Alexa::getGlobalRank() . '<br>';
echo "Country Rank: ";
print_r(seoapi\Alexa::getCountryRank()). '<br>';

echo "Page Load Time: ";
echo seoapi\Alexa::getPageLoadTime(). '<br>';

echo seoapi\Google::getPageRank(). '<br>';


}
catch (seoapiException $e) {
  die($e->getMessage());
}
?> -->
